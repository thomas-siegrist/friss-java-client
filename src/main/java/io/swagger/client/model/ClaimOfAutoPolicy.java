...
public class ClaimOfAutoPolicy extends AdditionalFieldsAndNotesBase {
    ...
    private WithdrawalReason withdrawalReason = null;
    ...
    public ClaimOfAutoPolicy policy(Policy policy) {
        this.policy = policy;
        return this;
    }
    ...
    public ClaimOfAutoPolicy witnesses(List<LegalEntityRef> witnesses) {
        this.witnesses = witnesses;
        return this;
    }

    public ClaimOfAutoPolicy addWitnessesItem(LegalEntityRef witnessesItem) {
    ...
    public ClaimOfAutoPolicy reporters(List<LegalEntityRef> reporters) {
        this.reporters = reporters;
        return this;
    }

    public ClaimOfAutoPolicy addReportersItem(LegalEntityRef reportersItem) {
    ...
    public ClaimOfAutoPolicy claimants(List<LegalEntityRef> claimants) {
        this.claimants = claimants;
        return this;
    }

    public ClaimOfAutoPolicy addClaimantsItem(LegalEntityRef claimantsItem) {
    ...
    public ClaimOfAutoPolicy subClaims(List<SubClaim> subClaims) {
        this.subClaims = subClaims;
        return this;
    }

    public ClaimOfAutoPolicy addSubClaimsItem(SubClaim subClaimsItem) {
    ...
    public ClaimOfAutoPolicy address(Address address) {
    ...
    public ClaimOfAutoPolicy reportType(String reportType) {
    ...
    public ClaimOfAutoPolicy numberOfVehicles(Integer numberOfVehicles) {
    ...
    public ClaimOfAutoPolicy numberOfThirdParties(Integer numberOfThirdParties) {
    ...
    public ClaimOfAutoPolicy numberOfInjured(Integer numberOfInjured) {
    ...
    public ClaimOfAutoPolicy incidentId(String incidentId) {
    ...
    public ClaimOfAutoPolicy flag(List<String> flag) {
        this.flag = flag;
        return this;
    }

    public ClaimOfAutoPolicy addFlagItem(String flagItem) {
        if (this.flag == null) {
    ...
    public ClaimOfAutoPolicy compensationType(String compensationType) {
    ...
    public ClaimOfAutoPolicy amountRecovered(BigDecimal amountRecovered) {
    ...
    public ClaimOfAutoPolicy amountPaid(BigDecimal amountPaid) {
    ...
    public ClaimOfAutoPolicy status(ClaimStatus status) {
        this.status = status;
        return this;
    }
    ...
    public ClaimOfAutoPolicy handler(String handler) {
    ...
    public ClaimOfAutoPolicy statement(String statement) {
    ...
    public ClaimOfAutoPolicy damageAmount(Integer damageAmount) {
    ...
    public ClaimOfAutoPolicy damageList(List<String> damageList) {
        this.damageList = damageList;
        return this;
    }

    public ClaimOfAutoPolicy addDamageListItem(String damageListItem) {
    ...
    public ClaimOfAutoPolicy damageType(String damageType) {
    ...
    public ClaimOfAutoPolicy accidentType(String accidentType) {
    ...
    public ClaimOfAutoPolicy liability(Integer liability) {
    ...
    public ClaimOfAutoPolicy cause(String cause) {
        this.cause = cause;
        return this;
    }
    ...
    public ClaimOfAutoPolicy amountReserved(BigDecimal amountReserved) {
    ...
    public ClaimOfAutoPolicy reportedDate(OffsetDateTime reportedDate) {
    ...
    public ClaimOfAutoPolicy occurredDate(OffsetDateTime occurredDate) {
    ...
    public ClaimOfAutoPolicy claimId(String claimId) {
    ...
    public ClaimOfAutoPolicy timeOccurred(String timeOccurred) {
    ...
    public ClaimOfAutoPolicy timeReported(String timeReported) {
    ...
    public ClaimOfAutoPolicy policeInvolved(Boolean policeInvolved) {
    ...
    public ClaimOfAutoPolicy recoveryClaim(Boolean recoveryClaim) {
    ...
    public ClaimOfAutoPolicy amountClaimed(BigDecimal amountClaimed) {
    ...
    public ClaimOfAutoPolicy reopenDate(OffsetDateTime reopenDate) {
    ...
    public ClaimOfAutoPolicy closingDate(OffsetDateTime closingDate) {
    ...
    public ClaimOfAutoPolicy damageCauser(String damageCauser) {
    ...
    public ClaimOfAutoPolicy withdrawalReason(WithdrawalReason withdrawalReason) {
    ...
    public ClaimOfAutoPolicy faultRating(String faultRating) {
    ...
    public ClaimOfAutoPolicy closedOutcome(String closedOutcome) {
    ...
    public ClaimOfAutoPolicy thirdParties(List<ThirdParty> thirdParties) {
        this.thirdParties = thirdParties;
        return this;
    }

    public ClaimOfAutoPolicy addThirdPartiesItem(ThirdParty thirdPartiesItem) {
    ...
    public ClaimOfAutoPolicy staffAppraisers(List<String> staffAppraisers) {
        this.staffAppraisers = staffAppraisers;
        return this;
    }

    public ClaimOfAutoPolicy addStaffAppraisersItem(String staffAppraisersItem) {
    ...
    public ClaimOfAutoPolicy custodians(List<LegalEntityRef> custodians) {
        this.custodians = custodians;
        return this;
    }

    public ClaimOfAutoPolicy addCustodiansItem(LegalEntityRef custodiansItem) {
    ...
    public ClaimOfAutoPolicy adverseParties(List<LegalEntityRef> adverseParties) {
        this.adverseParties = adverseParties;
        return this;
    }

    public ClaimOfAutoPolicy addAdversePartiesItem(LegalEntityRef adversePartiesItem) {
    ...
    public ClaimOfAutoPolicy vendors(List<LegalEntityRef> vendors) {
        this.vendors = vendors;
        return this;
    }

    public ClaimOfAutoPolicy addVendorsItem(LegalEntityRef vendorsItem) {
    ...
    public ClaimOfAutoPolicy pedestrians(List<LegalEntityRefOfPerson> pedestrians) {
        this.pedestrians = pedestrians;
        return this;
    }

    public ClaimOfAutoPolicy addPedestriansItem(LegalEntityRefOfPerson pedestriansItem) {
    ...
    public boolean equals(java.lang.Object o) {
        ...
        ClaimOfAutoPolicy claimOfAutoPolicy = (ClaimOfAutoPolicy) o;
        return Objects.equals(this.policy, claimOfAutoPolicy.policy) &&
                Objects.equals(this.witnesses, claimOfAutoPolicy.witnesses) &&
                Objects.equals(this.reporters, claimOfAutoPolicy.reporters) &&
                Objects.equals(this.claimants, claimOfAutoPolicy.claimants) &&
                Objects.equals(this.subClaims, claimOfAutoPolicy.subClaims) &&
                Objects.equals(this.address, claimOfAutoPolicy.address) &&
                Objects.equals(this.reportType, claimOfAutoPolicy.reportType) &&
                Objects.equals(this.numberOfVehicles, claimOfAutoPolicy.numberOfVehicles) &&
                Objects.equals(this.numberOfThirdParties, claimOfAutoPolicy.numberOfThirdParties) &&
                Objects.equals(this.numberOfInjured, claimOfAutoPolicy.numberOfInjured) &&
                Objects.equals(this.incidentId, claimOfAutoPolicy.incidentId) &&
                Objects.equals(this.flag, claimOfAutoPolicy.flag) &&
                Objects.equals(this.compensationType, claimOfAutoPolicy.compensationType) &&
                Objects.equals(this.amountRecovered, claimOfAutoPolicy.amountRecovered) &&
                Objects.equals(this.amountPaid, claimOfAutoPolicy.amountPaid) &&
                Objects.equals(this.status, claimOfAutoPolicy.status) &&
                Objects.equals(this.handler, claimOfAutoPolicy.handler) &&
                Objects.equals(this.statement, claimOfAutoPolicy.statement) &&
                Objects.equals(this.damageAmount, claimOfAutoPolicy.damageAmount) &&
                Objects.equals(this.damageList, claimOfAutoPolicy.damageList) &&
                Objects.equals(this.damageType, claimOfAutoPolicy.damageType) &&
                Objects.equals(this.accidentType, claimOfAutoPolicy.accidentType) &&
                Objects.equals(this.liability, claimOfAutoPolicy.liability) &&
                Objects.equals(this.cause, claimOfAutoPolicy.cause) &&
                Objects.equals(this.amountReserved, claimOfAutoPolicy.amountReserved) &&
                Objects.equals(this.reportedDate, claimOfAutoPolicy.reportedDate) &&
                Objects.equals(this.occurredDate, claimOfAutoPolicy.occurredDate) &&
                Objects.equals(this.claimId, claimOfAutoPolicy.claimId) &&
                Objects.equals(this.timeOccurred, claimOfAutoPolicy.timeOccurred) &&
                Objects.equals(this.timeReported, claimOfAutoPolicy.timeReported) &&
                Objects.equals(this.policeInvolved, claimOfAutoPolicy.policeInvolved) &&
                Objects.equals(this.recoveryClaim, claimOfAutoPolicy.recoveryClaim) &&
                Objects.equals(this.amountClaimed, claimOfAutoPolicy.amountClaimed) &&
                Objects.equals(this.reopenDate, claimOfAutoPolicy.reopenDate) &&
                Objects.equals(this.closingDate, claimOfAutoPolicy.closingDate) &&
                Objects.equals(this.damageCauser, claimOfAutoPolicy.damageCauser) &&
                Objects.equals(this.withdrawalReason, claimOfAutoPolicy.withdrawalReason) &&
                Objects.equals(this.faultRating, claimOfAutoPolicy.faultRating) &&
                Objects.equals(this.closedOutcome, claimOfAutoPolicy.closedOutcome) &&
                Objects.equals(this.thirdParties, claimOfAutoPolicy.thirdParties) &&
                Objects.equals(this.staffAppraisers, claimOfAutoPolicy.staffAppraisers) &&
                Objects.equals(this.custodians, claimOfAutoPolicy.custodians) &&
                Objects.equals(this.adverseParties, claimOfAutoPolicy.adverseParties) &&
                Objects.equals(this.vendors, claimOfAutoPolicy.vendors) &&
                Objects.equals(this.pedestrians, claimOfAutoPolicy.pedestrians) &&
                super.equals(o);
    }
    ...
    public String toString() {
        ...
        sb.append("class ClaimOfAutoPolicy {\n");
